...
transactionsRouter.get('/', function (request, response) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, transactionRepository.find()];
                case 1:
                    transactions = _a.sent();
                    return [4, transactionRepository.getBalance()];
                case 2:
                    balance = _a.sent();
                    return [2, response.json({ transactions: transactions, balance: balance })];
            }
        });
    });
});
transactionsRouter.post('/', function (request, response) {
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4, createTransaction.execute({
                            title: title,
                            type: type,
                            value: value,
                            category: category,
                ...
                case 1:
                    transaction = _b.sent();
                    return [2, response.json(transaction)];
            }
        });
    });
});
transactionsRouter.delete('/:id', function (request, response) {
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, deleteTransaction.execute(String(id))];
                case 1:
                    _a.sent();
...
transactionsRouter.post('/import', upload.single('file'), function (request, response) {
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, importTransaction.execute(request.file.path)];
                case 1:
                    transactions = _a.sent();
                    return [2, response.json(transactions)];
            }
        });
    });
});
